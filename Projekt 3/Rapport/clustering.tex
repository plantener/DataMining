...
\caption{This shows the data points plotted onto the two most describing principal component. For each point is shown whether the subject in fact has or does not have the disease. Furthermore it is shown which cluster the subject is assigned to.}
\label{GMM}
\end{figure}
